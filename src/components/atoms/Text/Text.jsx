...
const Text = (props) => {
const { children, innerHTML, className, span, p, h1, h2, h3, h4, h5, h6 } = props;
return (
<>
    { span && innerHTML === '' && ( <span className={className}>{ children }</span>) }
    { span && innerHTML !== '' && ( <span className={className} dangerouslySetInnerHTML={{__html: innerHTML }}></span>) }
